...
export default function Stats() {
  ...
  return (
    <section ref={ref} style={{
      backgroundImage: `linear-gradient(rgba(255, 229, 217, 0.30), rgba(255, 229, 217, 0.30)), url(${statsBg})`,
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <h2 style={{ fontFamily: "'Cinzel', serif", fontSize: 'clamp(2rem, 4vw, 3rem)', color: '#1C231A' }}>
